...
{{< gallery caption-effect="fade" >}}
  {{< figure thumb="-thumb" link="/elide/img/hexagon.jpg" >}}
  {{< figure thumb="-thumb" link="/elide/img/sphere.jpg" caption="Sphere" >}}
  {{< figure thumb="-thumb" link="/elide/img/triangle.jpg" caption="Triangle" alt="This is a long comment about a triangle" >}}
{{< /gallery >}}
{{< load-photoswipe >}}
